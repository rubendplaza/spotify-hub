...
class RecommendationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bundle?.let {
            bundle.apply {
                val retrievedRecommendationsListList = getParcelableArrayList<SongModel>("recommendationsList")
                if (retrievedRecommendationsListList != null) {
                    recommendationsList.addAll(recommendationsList)
                }
